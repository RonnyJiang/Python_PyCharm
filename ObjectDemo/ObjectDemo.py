...
# -*- coding: utf-8 -*-
"""
 @desc: 写一个class，来比较面向对象编程的设计思想及与面向过程的区别 --数据封装、继承和多态是面向对象的三大特点
 @author: ronny
 @contact: set@aliyun.com
 @site: www.lemon.pub
 @software: PyCharm  @since:python 3.5.2(32bit) on 2016/11/9.18:58
"""
...
ronny = Student('Ronny',98)
sasa = Student('Sasa',62)
ronny.print_score()
sasa.print_score()


# 面向对象的设计思想是从自然界中来的，因为在自然界中，类（Class）和实例（Instance）的概念是很自然的。Class是一种抽象概念，
# 比如我们定义的Class——Student，是指学生这个概念，而实例（Instance）则是一个个具体的Student，比如，ronny和sasa是两个具体的Student。
#
