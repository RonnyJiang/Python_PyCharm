...
# -*- coding: utf-8 -*-
"""
 @desc:Sort也是一个高阶函数。用sorted()排序的关键在于实现一个映射函数。
 @author: ronny
 @contact: set@aliyun.com
 @site: www.lemon.pub
 @software: PyCharm  @since:python 3.5.2(32bit) on 2016/11/9.10:23
"""
'''
排序算法
...
# 我们再看一个字符串排序的例子：
print(sorted(['bob', 'about', 'Zoo', 'Credit']))  #echo : ['Credit', 'Zoo', 'about', 'bob']
...
print(sorted(['bob', 'about', 'Zoo', 'Credit'], key=str.lower))  #echo:['about', 'bob', 'Credit', 'Zoo']
